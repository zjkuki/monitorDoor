...
public final class OkHttpUtils {
    ...
    public static JSONObject parseJSON(String s){
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(MyApplication.context, R.string.network_error, Toast.LENGTH_SHORT).show();
            return null;
        }
        String state = j.optString("state");
        if (!state.equals("successful")) {
            Toast.makeText(MyApplication.context, j.optString("reason"), Toast.LENGTH_SHORT).show();
            return null;
        }
        return j;
    }
