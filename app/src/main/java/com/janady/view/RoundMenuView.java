...
/**  调用方法
 * 		//roundMenuView = new CustomCircle(this);
 *
 ...
 *         roundMenu.icon= BitmapFactory.decodeResource(this.getResources(), R.drawable.ic_arrow_left);
 *         roundMenu.onClickListener=new OnClickListener() {
 *             @Override
 *             public void onClick(View view) {
 *                 Toast.makeText(mContext, "点击了左", Toast.LENGTH_SHORT).show();
 *             }
 *         };
 ...
 *         roundMenu.selectSolidColor = Color.GRAY;
 *         roundMenu.strokeColor = Color.GRAY;
 *         roundMenu.icon= BitmapFactory.decodeResource(this.getResources(), R.drawable.ic_arrow_right);
 *         roundMenu.onClickListener=new OnClickListener() {
 *             @Override
 *             public void onClick(View view) {
 ...
 *             @Override
 *             public void onClick(View view) {
 *                 Toast.makeText(mContext, "点击了4", Toast.LENGTH_SHORT).show();
 *             }
 *         };
 *         roundMenuView.addRoundMenu(roundMenu);
 *
 ...
 *                 , 1, 0.43,BitmapFactory.decodeResource(this.getResources(), R.drawable.icon_voice_talk), new OnClickListener() {
 *                     @Override
 *                     public void onClick(View view) {
 *                         Toast.makeText(mContext,"点击了中心圆圈", Toast.LENGTH_SHORT);
 *                     }
 *                 });
 * */
