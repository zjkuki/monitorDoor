...
public class ActivityGuideDeviceSetup extends ActivityGuide {
	...
	protected void addDemoModules() {
		...
		if (info != null && info.getVideoInChannel() > mFunDevice.CurrChannel) {
			// 编码配置
			mGuideModules.add(new DemoModule(R.drawable.ic_encode_120dp, R.string.device_setup_encode,
		...
		if (mFunDevice.channel != null && mFunDevice.channel.nChnCount == 1) {
			// 图像配置
			mGuideModules.add(new DemoModule(R.drawable.ic_videocam_120dp, R.string.device_setup_image,
					R.string.device_setup_hint_picture_config_alarm, ActivityGuideDeviceSetupCamera.class));
			// 高级配置
			mGuideModules.add(new DemoModule(R.drawable.ic_settings_120dp, R.string.device_setup_expert,
		...
		// 设备存储管理
		mGuideModules.add(new DemoModule(R.drawable.ic_sd_storage_120dp, R.string.device_setup_storage,
		...
		// 关于设备/设备信息
		mGuideModules.add(new DemoModule(R.drawable.ic_info_outline_120dp, R.string.device_system_info, R.string.device_setup_hint_about_dev_alarm,
